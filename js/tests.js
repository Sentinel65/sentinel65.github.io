$(document).ready(function() {
  assertScoreByName(['Tornádo', 'Stoletá voda', 'Elfí lučištník'], 35);
  assertScoreByName(['Kouř', 'Trpasličí pěchota', 'Válečná loď'], 50);
  assertScoreByName(['Svíčka', 'Kouř', 'Trpasličí pěchota', 'Válečná loď'], 44);
  ...
  assertScoreByCode('3,17,32,43,46,47,49+49:47:Wizard-Čaroděj', 380, 'Rulebook example II');
  assertScoreByCode('3,17,28,38,43,46,47,49+49:3:Leader-Vůdce', 397, 'Best hand ever?');
  assertScoreByCode('2,3,5,17,26,28,47,49+49:17:Land-Země', 388, 'Second best');
  assertScoreByCode('3,17,28,32,43,46,47,49+49:3:Army-Armáda', 388, 'Second best');
